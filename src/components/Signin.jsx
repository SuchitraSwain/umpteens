...
const Signin = ({ handleSignIn }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!username || !password) {
      ...
      axios
        .post("https://umpteens-backend.herokuapp.com/api/signin", user, {
          //Local - http://localhost:5000/api/signin // Production - https://umpteens-backend.herokuapp.com/api/signin
          headers: {
        ...
        .catch((err) => {
          ...
          setAlertMsg(err.response.data.err);
          setAuth(true);
          setLoading(false);
  ...
  return isSignedIn ? (
    <Personal handleSignIn={handleSignIn} data={data} />
  ) : (
    <>
      {/* <div id="forgtmodel">
        <div
      ...
      <section className="signinmidle_scn">
        <div className="container">
          {fields && <AlertMsg color="red" msg="Required Fields are Empty" />}
          {auth && <AlertMsg color="red" msg={alertMsg} />}
          <div className="row">
                  ...
                  <div className="col-md-6">
                    <div className="welcmtxt">
                      <div className="welcmtxt1">
                        <h1 className="mt-5">Welcome Back Students!</h1>
